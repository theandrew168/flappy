...
def texture2header(resource_file):
    ...
    print('texture: {} {} {}x{}'.format(os.path.basename(resource_file), format, width, height))
...
def model2header(resource_file):
    ...
    print('model: {} {} {} vertices'.format(resource_file, format, len(vertices)))
    return 'TODO'
...
def shader2header(resource_file):
    ...
    with open(resource_file) as f:
        source = f.read()
    print('shader: {} {} {} bytes'.format(resource_file, type, len(source)))
    return 'TODO'
